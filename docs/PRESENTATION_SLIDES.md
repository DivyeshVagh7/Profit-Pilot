...
- benchmark-adjusted reward subtracts equal-weight benchmark performance
- transaction costs are included

What to say: This reward is better than raw profit only because it checks whether the agent beats a simple passive strategy.

## Slide 13: Risk Management

- buy and sell costs included in the environment
- planned originality: drawdown guard and risk limits
- later extension: stop-loss or trading halt during poor performance

What to say: Risk control is important because RL can otherwise learn overly aggressive behavior.
